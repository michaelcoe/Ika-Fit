...
def main():
    homeImagePath = r'C:\Users\micha\Dropbox\UUV Project\Pictures'
    homeFigurePath = r'C:\Users\micha\Dropbox\Journal Articles\Non-contact Surface Area Approximation\figures'
